...
export default function HomeContent() {
  ...
  return (
    <div className="w-full overflow-x-hidden font-sans bg-white text-[#0A1128]">
      ...
      <section 
        id="hero" 
        className="relative min-h-screen flex flex-col items-center justify-center px-8 overflow-hidden bg-gradient-to-b from-white via-slate-50/50 to-white"
      >
        {/* Background Glows */}
        <motion.div 
          ...
          <div className="text-center md:text-left">
            <FadeInUp delay={0.2}>
              ...
              <h1 className="text-4xl md:text-6xl font-medium tracking-tight mb-8 text-[#0A1128] leading-tight">
                ...
                <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#C9A84C] to-[#8B7355]">선물합니다.</span>
              </h1>
            </FadeInUp>
          </div>
        </div>
      ...
      <section 
        id="vision" 
        className="relative min-h-screen flex items-center justify-center bg-[#0A1128] px-8 overflow-hidden"
      >
      ...
      <section id="contact" className="relative min-h-screen flex flex-col justify-between bg-[#FAFAFC] pt-20 overflow-hidden">
        ...
        <div className="flex-grow flex items-center justify-center px-8 py-10 relative z-10">
          <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-16">
            <FadeInUp>
              ...
              <div className="space-y-4 text-lg">
                <div className="flex items-center gap-4 group p-4 rounded-2xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
                  <div className="w-12 h-12 rounded-full bg-blue-50 flex items-center justify-center group-hover:bg-[#0A1128] group-hover:scale-110 transition-all duration-300 shadow-sm">
                    <Phone size={20} className="text-blue-900 group-hover:text-white transition-colors" />
                  </div>
                  <span className="text-gray-700 font-medium tracking-wide">010-6868-9321</span>
                </div>
                <div className="flex items-center gap-4 group p-4 rounded-2xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
                  <div className="w-12 h-12 rounded-full bg-blue-50 flex items-center justify-center group-hover:bg-[#0A1128] group-hover:scale-110 transition-all duration-300 shadow-sm">
                    <Mail size={20} className="text-blue-900 group-hover:text-white transition-colors" />
                  </div>
                  <span className="text-gray-700 font-medium tracking-wide">byulsi@naver.com</span>
                </div>
                <div className="flex items-center gap-4 group cursor-pointer p-4 rounded-2xl hover:bg-[#FFF9C4]/30 transition-colors border border-transparent hover:border-[#FEE500]/50">
                  <div className="w-12 h-12 rounded-full bg-[#FEE500] flex items-center justify-center group-hover:scale-110 transition-all duration-300 shadow-sm">
                    <MessageCircle size={20} className="text-[#371D1E]" />
                  </div>
            ...
            <FadeInUp delay={0.2} className="relative overflow-hidden bg-gradient-to-br from-[#0A1128] to-[#1E2E5C] p-10 md:p-12 rounded-3xl text-white flex flex-col justify-center shadow-2xl border border-white/10">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-light mb-10 leading-snug">
                  의미 있는 경험으로 <br />
                  <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400">가치 있는 시간</span>을 만듭니다.
                </h3>
                <div className="grid grid-cols-2 gap-8 relative before:absolute before:inset-0 before:bg-gradient-to-r before:from-white/20 before:to-transparent before:h-px before:-top-5">
                  <div>
                    <p className="text-4xl font-bold tracking-tight">1,000<span className="text-[#C9A84C]">+</span></p>
                    <p className="text-gray-400 text-xs mt-2 uppercase tracking-widest font-medium">Students</p>
                  </div>
                  <div>
                    <p className="text-4xl font-bold tracking-tight">100<span className="text-[#C9A84C]">+</span></p>
        ...
        {/* Footer */}
        <footer className="relative z-10 border-t border-gray-200 py-12 px-8 bg-white/60 backdrop-blur-md">
